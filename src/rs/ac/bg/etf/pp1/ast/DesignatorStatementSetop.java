...
public class DesignatorStatementSetop extends DesignatorStatement {
    ...
    public DesignatorStatementSetop (Designator Designator, Assignop Assignop, Designator Designator1, Setop Setop, Designator Designator2) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatementSetop(\n");
